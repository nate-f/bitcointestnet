...
namespace Structures.Messages.Tests
{
    ...
    public class TransactionTests
    {
        ...
        {
            var tx = Message.CreateMessageFromByteArray(exampleTx1);
        }
        private byte[] exampleTx1 = new byte[] {0xF9, 0xBE, 0xB4 , 0xD9 , 0x74 , 0x78 , 0x00 , 0x00  , 0x00 , 0x00 , 0x00 , 0x00 , 0x00 , 0x00 , 0x00 , 0x00,
